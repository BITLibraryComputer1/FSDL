...
def generateCSV(request):
    ...
    for course in courses:
        writer.writerow([course.courseCode, course.courseName, course.courseCredits])
    return resp
...
def generatePDF(request):
    ...
    for course in courses:
        table_data.append([course.courseCode, course.courseName, str(course.courseCredits)])
